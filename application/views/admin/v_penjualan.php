    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <center><?php echo $this->session->flashdata('msg');?></center>
                <h1 class="page-header">Transaksi
                    ...
                    <a href="#" data-toggle="modal" data-target="#largeModal" class="float-right"><small>Cari Produk!</small></a>
                </h1> 
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-lg-12">
            <form action="<?php echo base_url().'adminn/penjualan/add_to_cart'?>" method="post">
            <table>
                <tr>
                    <th>Kode Barang</th>
                </tr>
                <tr>
                    <th><input type="text" name="kode_brg" id="kode_brg" style="width:190px;margin-right:5px;" class="form-control input-sm"></th>                     
                </tr>
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;margin-top:10px;">
                ...
                <tbody>
                    ...
                    <tr>
                         ...
                         <td style="text-align:center;"><a href="<?php echo base_url().'adminn/penjualan/remove/'.$items['rowid'];?>" class="btn btn-warning btn-xs"><span class="fa fa-close"></span> Batal</a></td>
                    </tr>
            ...
            <form action="<?php echo base_url().'adminn/penjualan/simpan_penjualan'?>" method="post">
            <table>
                <tr>
        ...
        $(document).ready(function(){
            ...
            $("#kode_brg").on("input",function(){
                var kobar = {kode_brg:$(this).val()};
                   $.ajax({
               type: "POST",
               url : "<?= base_url().'adminn/penjualan/get_barang';?>",
               data: kobar,
